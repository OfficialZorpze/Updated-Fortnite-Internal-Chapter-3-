...
//Linora Updated Chapter 3 (if you sell this i will eat your dog - oracl) 

//source on github: https://github.com/UE5Zorpze/Updated-Fortnite-Internal-Chapter-3-

//Enjoy skiddos <3

//Heads up: Removed some of the esp and shit because idk and fix the aimbot yourself but the rest of the shit is updated and works. aimbot will crash so. Have fun ig
...
VOID MenuAndDestroy(ImGuiWindow& window) {
	...
	if (ShowMenu) {
		...
		static int maintabs;
		static int esptabs;
		if (ImGui::Begin(xorstr("Updated season 3"), &ShowMenu, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse)) {
			...
			if (maintabs == 0) {
				...
				if (Menu_AimBoneInt == 0) Settings::aimbone = 98;
				if (Menu_AimBoneInt == 1) Settings::aimbone = 66;
				...
				ImGui::Checkbox("Vehicle Fly", &Settings::VehicleFly);
			}
